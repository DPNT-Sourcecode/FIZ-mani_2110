...
public class FizzBuzzSolutionTest {
    ...
    public void compute_hello() {
        ...
        assertThat(fizzBuzz.fizzBuzz(222),  equalTo("fizz"));
        ...
        assertThat(fizzBuzz.fizzBuzz(555),  equalTo("fizz buzz"));
        assertThat(fizzBuzz.fizzBuzz(5555),  equalTo("buzz"));
        ...
        assertThat(fizzBuzz.fizzBuzz(777),  equalTo("fizz"));
