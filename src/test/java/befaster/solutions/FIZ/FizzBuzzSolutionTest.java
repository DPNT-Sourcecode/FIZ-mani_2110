...
public class FizzBuzzSolutionTest {
    ...
    @Test
    public void compute_fizz_deluxe() {
        assertThat(fizzBuzz.fizzBuzz(3636), equalTo("fizz deluxe")); // fizz
    }

    @Test
    public void compute_fizz_fake_deluxe() {
    ...
    @Test
    public void compute_buzz_deluxe() {
        assertThat(fizzBuzz.fizzBuzz(500), equalTo("buzz deluxe")); // buzz
    }

    @Test
    public void compute_buzz_fake_deluxe() {
    ...
    public void compute_fizz_buzz_deluxe() {
        assertThat(fizzBuzz.fizzBuzz(30), equalTo("fizz deluxe")); // tdl: fizz buzz, deluxe  us: fizz deluxe
    ...
    public void compute_fizz_buzz_fake_deluxe() {
        ...
        assertThat(fizzBuzz.fizzBuzz(45), equalTo("fizz buzz fake deluxe")); // tdl: , us fizz buzz fake deluxe
